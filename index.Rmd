...
#sudah <- nrow(filter(db, registrasi == "registrasi"))
valueBox(
  value = paste(format(data0$regis[4], big.mark = " "), "", sep = " "),
  caption = "SMBNU",
  icon = "fas fa-thumbs-up",
  color = "cadetblue"
)
...
#sudah <- nrow(filter(db, registrasi == "registrasi"))
valueBox(
  value = paste(format(data0$regis[5], big.mark = " "), "", sep = " "),
  caption = "UMMD3",
  icon = "fas fa-thumbs-up",
  color = "dodgerblue"
)
...
#sudah <- nrow(filter(db, registrasi == "registrasi"))
valueBox(
  value = paste(format(data0$regis[6], big.mark = " "), "", sep = " "),
  caption = "JAJ",
  icon = "fas fa-thumbs-up",
...
#sudah <- nrow(filter(db, registrasi == "registrasi"))
valueBox(
  value = paste(format(data0$regis[7], big.mark = " "), "", sep = " "),
  caption = "ADIK",
  icon = "fas fa-thumbs-up",
...
#sudah <- nrow(filter(db, registrasi == "registrasi"))
valueBox(
  value = paste(format(data0$regis[8], big.mark = " "), "", sep = " "),
  caption = "JPL",
  icon = "fas fa-thumbs-up",
  color = "darkorange"
)
...
#sudah <- nrow(filter(db, registrasi == "registrasi"))
valueBox(
  value = paste(format(data0$regis[9], big.mark = " "), "", sep = " "),
  caption = "S2",
  icon = "fas fa-thumbs-up",
  color = "darkblue"
)
...
#sudah <- nrow(filter(db, registrasi == "registrasi"))
valueBox(
  value = paste(format(data0$regis[10], big.mark = " "), "", sep = " "),
  caption = "S3",
  icon = "fas fa-thumbs-up",
  color = "darkgreen"
)
...
#sudah <- nrow(filter(db, registrasi == "registrasi"))
valueBox(
  value = paste(format(data0$regis[11], big.mark = " "), "", sep = " "),
